...
def cache_monthly_data(employee_id: str, year: str, month: str, monthly_data: MonthlyData) -> None:
    ...
    for daily in monthly_data.daily_list:
        daily_dict = {
            ...
            'alternatuve_work_date1': daily.alternatuve_work_date1.isoformat() if daily.alternatuve_work_date1 else None,
            'alternatuve_work_date2': daily.alternatuve_work_date2.isoformat() if daily.alternatuve_work_date2 else None,
            'alternatuve_work_date3': daily.alternatuve_work_date3.isoformat() if daily.alternatuve_work_date3 else None,
            'notes': daily.notes,
    ...
    try:
        ...
        for daily_dict in data_dict['daily_list']:
            daily = DailyData(
                ...
                alternatuve_work_date1=date.fromisoformat(daily_dict.get('alternatuve_work_date1', daily_dict.get('alternative_work_date', ''))) if daily_dict.get('alternatuve_work_date1', daily_dict.get('alternative_work_date')) else None,
                alternatuve_work_date2=date.fromisoformat(daily_dict['alternatuve_work_date2']) if daily_dict.get('alternatuve_work_date2') else None,
                alternatuve_work_date3=date.fromisoformat(daily_dict['alternatuve_work_date3']) if daily_dict.get('alternatuve_work_date3') else None,
