...
class AttendanceDaily(models.Model):
    ...
    alternative_work_date1 = models.DateField(verbose_name='代休/振替の勤務日1', null=True, blank=True)
    alternative_work_date2 = models.DateField(verbose_name='代休/振替の勤務日2', null=True, blank=True)
    alternative_work_date3 = models.DateField(verbose_name='代休/振替の勤務日3', null=True, blank=True)
